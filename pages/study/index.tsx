...
const Study: NextPage = () => {
  return (
    <>
      ...
      <Header />
      <div className="w-screen h-full flex flex-col gap-10 justify-start items-center bg-black">
        ...
        {Studys.map((study) => (
          ...
          >
            <div className="text-white flex flex-col justify-center gap-2 border-white border-2 px-6 py-2">
