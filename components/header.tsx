  ...
  return (
    ...
    >
      <div className="flex justify-between items-center px-12 pt-1">
        <div className="text-2xl font-bold text-gray-500 hover:text-white">
        ...
        <div
          className={
            Window >= 640
              ? "w-full max-w-sm flex justify-around items-center text-lg sm:text-xl font-bold text-gray-500"
              : cls(
                  "w-full max-w-sm flex justify-around text-lg sm:text-xl font-bold text-gray-500",
                  "hidden"
                )
          }
        >
        ...
        <svg
          className={
            Window < 640
              ...
              : cls("h-8 w-8 cursor-pointer", "hidden")
          }
          onClick={onClick}
          viewBox="0 0 24 24"
        ...
        <div
          className={
            Window < 640 && clicked
              ? "absolute top-0 w-screen h-screen flex flex-col gap-6 bg-blue-200"
              : cls(
                  "absolute top-0 w-screen h-screen flex flex-col gap-6 pt-2 pl-4 bg-blue-200",
                  "hidden"
                )
          }
        >
